...
import VanillaZkVM.Cost      -- cost model: cost-annotated algorithms (exact, explicit-constant costs)
import VanillaZkVM.BusE      -- tight unkeyed bus-unification reduction: exact costs + correctness
